...
ActiveRecord::Schema.define(version: 20160919025944) do
  ...
  create_table "story_saves", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["story_id"], name: "index_story_saves_on_story_id", using: :btree
    t.index ["user_id"], name: "index_story_saves_on_user_id", using: :btree
  end
